...
pub async fn list_accounts(
    ...
    let accounts: Vec<nmcscan_shared::models::entities::minecraft_accounts::Model> = state
...
pub async fn add_account(
    ...
    let account: nmcscan_shared::models::entities::minecraft_accounts::Model = state
        .minecraft_account_repo

...
<div
    class="min-h-screen bg-[#0b0f19] text-gray-200 font-sans selection:bg-blue-500/30 flex flex-col"
>
    <!-- Hero Section -->
    <header
        class="py-20 px-4 text-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/20 via-[#0b0f19] to-[#0b0f19]"
    >
        <div class="max-w-3xl mx-auto">
            <div
                class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-blue-600/10 text-blue-400 mb-8 border border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.15)]"
            >
                <svg
                    class="w-10 h-10"
                    fill="none"
            ...
            <p class="text-xl text-gray-400 leading-relaxed">
                You likely reached this page because you noticed an incoming
                connection from this IP address. This is part of an <span
                    class="text-blue-400 font-medium"
                    >Internet Research Project</span
                > focused on mapping the global Minecraft server ecosystem.
            </p>
        </div>
    </header>
    ...
    <!-- Info Grid -->
    <main
        class="flex-1 max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-12"
    >
        <!-- Left: About -->
        <div class="space-y-8">
            <div>
                ...
                <p class="text-gray-400 leading-relaxed">
                    NMCScan is a distributed scanning system that identifies
                    publicly accessible Minecraft servers. We only perform a
                    standard <span class="italic">Server List Ping</span>—the
                    same request your Minecraft client sends when you add a
                    server to your multiplayer list.
                </p>
            </div>

            <div
                class="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 space-y-4"
            >
        ...
        <!-- Right: Contact -->
        <div
            class="bg-gray-900 border border-gray-800 rounded-3xl p-8 shadow-xl relative overflow-hidden"
        >
            <div
                class="absolute top-0 right-0 w-32 h-32 bg-blue-500/5 blur-3xl rounded-full -mr-16 -mt-16"
            ></div>
            ...
            <p class="text-gray-400 text-sm mb-8">
                ...
                from future scans, please contact us through any of the
                following channels:
            </p>
            ...
            <div class="space-y-4">
                {#if contactInfo.discord}
                    ...
                    >
                        <div
                            class="w-12 h-12 rounded-lg bg-[#5865F2] flex items-center justify-center shadow-lg shadow-[#5865F2]/20"
                        >
                            <svg
                        ...
                        <div>
                            <div
                                class="text-white font-bold group-hover:text-blue-400 transition-colors"
                            >
                                Join our Discord
                            </div>
                            <div
                                class="text-gray-500 text-xs uppercase tracking-widest mt-0.5"
                            >
                                Instant Support
                            </div>
                        </div>
    ...
    <footer
        class="py-8 px-4 border-t border-gray-800/30 text-center text-gray-600 text-xs"
    >
        &copy; {new Date().getFullYear()} NMCScan Research | nTech. All rights reserved.
    </footer>
</div>
